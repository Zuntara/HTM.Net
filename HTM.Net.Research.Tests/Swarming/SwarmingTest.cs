...
namespace HTM.Net.Research.Tests.Swarming
{
    ...
    public class OneNodeTests : ExperimentTestBaseClass
    {
        ...
        public void TestLinearOpfInternal()
        {
            ...
            description.Item1.SetParameterByKey(Parameters.KEY.INPUT_DIMENSIONS, new[] {128});
            description.Item1.SetParameterByKey(Parameters.KEY.COLUMN_DIMENSIONS, new[] {128 });

            description.Item2.SetParameterByKey(Parameters.KEY.CLASSIFIER_ALPHA, new PermuteFloat(0.1,1.2));
        ...
        public void TestDescriptionSerialization()
        {
            ...
            var deserialized = Json.Deserialize<ExperimentParameters>(json);
