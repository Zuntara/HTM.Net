...
namespace HTM.Net.Research.Tests.Examples.Random
{
    public class NetworkDemoHarness
    {
        ...
        /// double, double, double, Boolean, Boolean, Boolean, String, String, String)}</param>
        ...
        /// <param name="radius">see <see cref="Encoder{T}"/></param>
        /// <param name="resolution">see <see cref="Encoder{T}"/></param>
        ...
        public static EncoderSettingsList GetNetworkDemoFieldEncodingMap()
        {
            EncoderSettingsList fieldEncodings = SetupMap(
                    ...
                    0, // w
                    0, 0, 0, 0, null, null, null,
                    "timestamp", FieldMetaType.DateTime, EncoderTypes.DateEncoder);
            fieldEncodings = SetupMap(
                    fieldEncodings,
                    50,
                    21,
        ...
        public static Parameters GetNetworkDemoTestEncoderParams()
        {
            ...
            p.SetParameterByKey(Parameters.KEY.FIELD_ENCODING_MAP, fieldEncodings.AsMap());
        ...
        public static Parameters GetParameters()
        {
            ...
            parameters.SetParameterByKey(Parameters.KEY.INPUT_DIMENSIONS, new int[] { 200 });
            parameters.SetParameterByKey(Parameters.KEY.COLUMN_DIMENSIONS, new int[] { 100, 7 }); // 1000,20
            parameters.SetParameterByKey(Parameters.KEY.CELLS_PER_COLUMN, 14);
            ...
            parameters.SetParameterByKey(Parameters.KEY.SYN_PERM_INACTIVE_DEC, 0.0015);// 0.015
            parameters.SetParameterByKey(Parameters.KEY.SYN_PERM_ACTIVE_INC, 0.00155);  // 0.155
            ...
            //parameters.SetParameterByKey(Parameters.KEY.SEED, 1579);
            //parameters.SetParameterByKey(Parameters.KEY.RANDOM, new XorshiftRandom(1579));
            ...
            parameters.SetParameterByKey(Parameters.KEY.MAX_NEW_SYNAPSE_COUNT, 16);
