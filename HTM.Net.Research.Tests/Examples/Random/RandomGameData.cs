...
namespace HTM.Net.Research.Tests.Examples.Random
{
    ...
    public class RandomGuess : List<RandomGuessData>
    {
        ...
        public static List<RandomGuess> GetFirstGuesses(List<RandomGuess> list, int cnt)
        {
    ...
    public class RandomGameData
    {
        ...
        public (int correctNumbersAct, bool correctBonus) CorrectPredictionsWithBonus { get; set; }
        public List<(int correctNumbersAct, bool correctBonus)> CorrectDeviationPredictionsWithBonus { get; set; }
        public (int correctNumbersAct, bool correctBonus) CorrectRandomPredictionsWithBonus { get; set; }
        ...
        {
            List<(int correctNumbersAct, bool correctBonus)> allResults = new List<(int correctNumbersAct, bool correctBonus)>();
        ...
        public static (int correctNumbersAct, bool correctBonus) CalculateOneGuess(int[] actuals, int[] predicted)
        {
            int correctNumbersAct = 0;

            Stack<int> predStack = new Stack<int>(predicted.Take(6)); // limit to 6 numbers
            List<int> actualList = new List<int>(actuals.Take(6));
            ...
            bool correctBonus = predicted.Last() == actuals.Last();
            return (correctNumbersAct, correctBonus);
        }
        ...
        public static int[] GetCountsOfCorrectRandomGuesses(IEnumerable<RandomGameData> collection)
        {
            return // skip first prediction, it's bogus
                collection.Skip(1)
                    .Select(gd => gd.CorrectRandomPredictionsWithBonus.correctNumbersAct + (gd.CorrectRandomPredictionsWithBonus.correctBonus ? 1 : 0))
                    .ToArray();
        }
        ...
        public static Map<string, int> GetCountsOfCorrectPredictedGuessesInStrings(ICollection<RandomGameData> collection)
        {
            // skip first prediction, it's bogus
            var results = collection.Skip(1)
        ...
        {
            return GetCountsOfCorrectPredictedGuessesInStrings(collection.Skip(collection.Count - lastCount).ToList());
        }
