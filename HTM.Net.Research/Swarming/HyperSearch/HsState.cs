    ...
    public class HsState
    {
        ...
        public void readStateFromDB()
        {
            ...
            if (this._priorStateJSON == null)
            {
                ...
                this._hsObj._cjDAO.jobSetFieldIfEqual(_hsObj._jobID, "engWorkerState", JsonConvert.SerializeObject(_state), null);
            ...
            this._state = JsonConvert.DeserializeObject<HsStateModel>(this._priorStateJSON);
            this._dirty = false;
        }
